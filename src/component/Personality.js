      ...
      <ul className="grid grid-cols-2">
        ...
        <div className="">
          <dl className="my-8">
            ...
            <dt className="mt-6 font-extrabold text-2xl text-purple-500 text-right">
              부정적
            </dt>
            <dd className="mr-12 p-4 border-2 border-purple-100 bg-gray-50">
            ...
            <dt className="mt-6 font-extrabold text-2xl text-purple-500">
              성실함
            </dt>
            <dd className="ml-12 p-4 border-2 border-purple-100">
